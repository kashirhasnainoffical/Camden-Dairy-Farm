    ...
    <main>
        ...
        <div class="bunner" style="display: block;">
            <div class="records">
                ...
                <button id="modal-btn" class="btn">View Rates and Discount</button>
                <button id="modal-btn" class="btn">View Recent Orders</button>
                <button id="modal-btn" class="btn">View Canceled Orders</button>
            </div>
        </div>
